...
public class InventoryLevelServiceImpl implements InventoryLevelService {
    ...
    public InventoryLevel createOrUpdateInventory(InventoryLevel inv) {
        ...
        Store store = storeRepository.findById(inv.getStore().getId()).orElse(inv.getStore());
        Product product = productRepository.findById(inv.getProduct().getId()).orElse(inv.getProduct());
